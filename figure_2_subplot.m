...
%%% Wavelet coherency: GDP AND MORTGAGES

[WC1,WXY1,periods1,coi1,pv_WC1, WGain] = ...
 AWCOG(gdp,mf_mort,dt,dj,low_period,up_period,pad,mother,beta,gamma,wt_size,ws_size,n_sur);
...
% old ylim phase difference, must increase a little to insert legend
...
%set(gca,'XLim',x_lim,'XTick',x_ticks,'XTickLabel',x_ticks)
...
switch savefigs
    case 1
        print('-depsc2', '-loose', 'figures/figure_8_left.eps');
end
hold off;
...
switch savefigs
    case 1
        print('-depsc2', '-loose', 'figures/figure_2ii.eps');
end
hold off;
